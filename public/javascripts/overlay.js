...
// Apply your own settings here, or override them in the html file.  
	...
	creditsText : 'Powered by <em style="font-size:10px">JA Highslide</em>',
	creditsHref : 'http://joomlart.com',
	creditsTitle : 'Go to Joomlart.com',
...
getSelfRendered : function() {
	var s =	
		 '<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td class="highslide-title">'
		+hs.vTitle+'</td>'
...
//		+	'<li class="highslide-move"><a href="#" onclick="return false">'+ hs.moveText +'</a></li>'
		+	'<td class="highslide-title"><div class="highslide-header"><ul><li class="highslide-close"><a onclick="return hs.close(this)" title="'+ hs.closeTitle +'" href="#"><img src="/images/close.png" width="22" height="21" border="0" align="absmiddle" /></a></li>'
		+'</ul></div></td></tr></table>'
...
//	if (!cache) cache = hs.getSelfRenderedTEST(ant");
...
//		this.content = hs.getSelfRenderedTEST("Vikrant");
...
preloadNext : function() {
	...
	if (next!=null && next.onclick.toString().match(/hs\.expand/)) 
...
{
	var getsetVal=getsetVal=str.value;
}
